...
path_in1 = "/home/leidinice/Documentos/esi/results/data/esi/clim/dado_12WK/"
...
for year in range(2003, 2015 + 1):
    ...
    for season in trim_esi:

        print year, season

        # Declaring variables
        name1 = 'esi_12WK_SMN_{0:04d}_SA.nc'.format(year)
        ...
        aux_in1 = data1.variables['esi'][dic_esi[season], min_lat_index:max_lat_index, min_lon_index:max_lon_index]  # Declaring variable under study to calculate the thiessen aux_in
...
for ano in range(2003, 2015+1):
    ...
    for mes in range(0, 12):
        ...
        name2 = 'spi_3_{0:04d}.nc'.format(ano)
...
plt.title(u'b. ESI-12WK x SPI-3 para a bacia do rio São Francisco\n Peíodo: 2003 - 2015')
plt.xlabel(u'Anos')
