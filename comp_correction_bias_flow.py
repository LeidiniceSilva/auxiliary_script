...
""" Bias correction of flow by gamma"""
...
if __name__ == '__main__':
    ...
    for basin in bas_new:
        ...
        path_out = ('{0}/results/results_flow_basins/monthly_corrected_gamma_desag/jan/'
        ...
        for k, yea in enumerate(range(2011, 2017)):
            ...
            name_nc = write_flow(aux, new_y, end_y, 'monthly', 'flow', 'echam46_hind8110', 'fcst',
                                 'correc_{0}'.format(basin_fullname), 'smap', init_date=start_y, output_path=path_out)