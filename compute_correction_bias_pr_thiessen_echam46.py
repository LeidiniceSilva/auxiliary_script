...
if __name__ == '__main__':
    ...
    for basin in basins:
        ...
        pr_corrected1 = gamma_correction(ste_hind1, stc_obs1[0], ste_fcst1)
        pr_corrected2 = gamma_correction(ste_hind2, stc_obs2[0], ste_fcst2)
        pr_corrected3 = gamma_correction(ste_hind3, stc_obs3[0], ste_fcst3)
        ...
        path_out1 = ('{0}/check_echam46_obs_basins/pr_thiessen/pr_thiessen_monthly_echam46_corrected_operation/figures/jan/{1}/'.format(hidropy_path, basin_dict(basin)[1]))
        path_out2 = ('{0}/check_echam46_obs_basins/pr_thiessen/pr_thiessen_monthly_echam46_corrected_operation/jan/{1}/'.format(hidropy_path, basin_dict(basin)[1]))
...
# fig = plt.figure(figsize=(14, 8))
# plt.hist(stc_obs3[0])
# plt.title(u'Histograma de Pr_Thiessen - OBS - Abr - 1981 - 2010\n bacia {0}'.format(basin_fullname))
# plt.xlabel("mm")
# plt.ylabel("Frequency")
# path1 = ('{0}/check_echam46_obs_basins/pr_thiessen/pr_thiessen_monthly_echam46_corrected_operation/figures/'
#             'histogram/obs/apr/{1}/'.format(hidropy_path, basin_dict(basin)[1]))
# if not os.path.exists(path1):
#     create_path(path1)
# plt.savefig(os.path.join(path1, 'hist_abr_obs_pr_thiessen_{0}.png'.format(basin_fullname)))
# plt.close('all')
# plt.cla()
#
# fig = plt.figure(figsize=(14, 8))
# plt.hist(np.array(ste_hind2))
# plt.title(u'Histograma de Pr_Thiessen - SIM - Mar - 1981 - 2010\n bacia {0}'.format(basin_fullname))
# plt.xlabel("mm")
# plt.ylabel("Frequency")
# path2 = ('{0}/check_echam46_obs_basins/pr_thiessen/pr_thiessen_monthly_echam46_corrected_operation/figures/'
#             'histogram/sim/mar/{1}/'.format(hidropy_path, basin_dict(basin)[1]))
# if not os.path.exists(path2):
#     create_path(path2)
# plt.savefig(os.path.join(path2, 'hist_mar_sim_pr_thiessen_{0}.png'.format(basin_fullname)))
# plt.close('all')
# plt.cla()
#
# fig = plt.figure(figsize=(14, 8))
# plt.hist(np.array(ste_hind3))
# plt.title(u'Histograma de Pr_Thiessen - SIM - Abr - 1981 - 2010\n bacia {0}'.format(basin_fullname))
# plt.xlabel("mm")
# plt.ylabel("Frequency")
# path2 = ('{0}/check_echam46_obs_basins/pr_thiessen/pr_thiessen_monthly_echam46_corrected_operation/figures/'
#             'histogram/sim/apr/{1}/'.format(hidropy_path, basin_dict(basin)[1]))
# if not os.path.exists(path2):
#     create_path(path2)
# plt.savefig(os.path.join(path2, 'hist_abr_sim_pr_thiessen_{0}.png'.format(basin_fullname)))
# plt.close('all')
# plt.cla()