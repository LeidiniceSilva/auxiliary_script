...
if __name__ == '__main__':
    ...
    for basin in basins:
        ...
        for year1 in range(1981, 2011):
            ...
            arq3 = "{0}/{1}_{2}_echam46_hind8110_fcst_{3}0101_{3}0201_{3}0430_thiessen_{4}.nc".format(link2, param, scale,
        ...
        for year2 in range(2011, 2017):
            ...
            arq4 = "{0}/{1}_{2}_echam46_hind8110_fcst_{3}0101_{3}0201_{3}0430_thiessen_{4}.nc".format(link3, param, scale,
                                                                                                      year2, basin_fullname)
