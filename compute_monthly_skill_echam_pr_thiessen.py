...
if __name__ == '__main__':
    ...
    for basin in basins:
        ...
        st = variable1[252:603] # A partir de setembro - 1982 a 2011 jan-1982 a mar-2011
        st1 = variable1[240:600] # 1981 - 2010 - jan 1981 - dez - 2010

        stc1.append(st1[2::12])
        stc2.append(st1[3::12])
        stc3.append(st1[4::12])
        ...
        link2 = home + "/io/echam46/hind8110/feb/monthly/{0}_thiessen/{1}".format(param, macro_name)
        for year in range(1981, 2010 + 1):
            arq2 = "{0}/{1}_{2}_echam46_hind8110_fcst_{3}0201_{3}0301_{3}0531_thiessen_{4}.nc".format(link2, param, scale,
                                                                                                      year, basin_fullname)
