...
if __name__ == '__main__':
    ...
    for basin in basins:
        ...
        stc_obs.append(st1[1::12] + st1[2::12] + st1[3::12])
        ...
        sto.append(observ[1::12] + observ[2::12] + observ[3::12])
        ...
        plt.title(u'Comparação da Pr_Thiessen - OBS x BRUTO x CORRIGIDO - Jan (F-M-A)'
