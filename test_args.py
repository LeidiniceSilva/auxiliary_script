...
if __name__ == '__main__':
    ...
    for basin in bas_new:
        ...
        for mes_ini in ['jan', 'feb', 'mar', ]:
            # open netcdf obs

            mes1 = mes_prev[mes_ini][0]
            mes2 = mes_prev[mes_ini][1]
            mes3 = mes_prev[mes_ini][2]
            ...
            stc.append(st_obs1[mes1::12] + st_obs1[mes2::12] + st_obs1[mes3::12])
            sto1.append(st_obs2[mes1::12])
            sto2.append(st_obs2[mes2::12])
            sto3.append(st_obs2[mes3::12])
