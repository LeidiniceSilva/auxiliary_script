...
if __name__ == '__main__':
    ...
    macros_inc = ['amazonas', 'atlantico_leste', 'doce', 'grande', 'iguacu', 'jacui', 'paraiba_do_sul', 'parana', 'paranaiba',
    ...
    for macro in macros_total:
        ...
        for basin in bas_new:
            ...
            arq1 = "{0}/{1}_{2}_inmet_ana_chirps_obs_19770215_20161115_smap_{3}.nc".format(link1, param, scale,
                                                                                           basin_fullname)
            ...
            stc_obs1.append(st_obs2[1::12])
            stc_obs2.append(st_obs2[2::12])
            stc_obs3.append(st_obs2[3::12])
            stc_obs_acc.append(st_obs1[1::12] + st_obs1[2::12] + st_obs1[3::12])
            ...
            link3 = home + "/io/{0}/{1}/{2}/{3}/{4}_smap/{5}".format(model, period, mon, scale, param, macro_name)
            for year1 in range(1981, 2011):
                arq3 = "{0}/{1}_{2}_{3}_{4}_fcst_{5}0101_{5}0215_{5}0415_smap_{6}.nc".format(link3, param,  scale,
                                                                                                 model, period, year1,
                                                                                                 basin_fullname)
            ...
            link4 = home + "/io/{0}/{1}/{2}/{3}/{4}_smap/{5}".format(model, period, mon, scale, param, macro_name)
            for year2 in range(2011, 2017):
                arq4 = "{0}/{1}_{2}_{3}_{4}_fcst_{5}0101_{5}0215_{5}0415_smap_{6}.nc".format(link4, param,  scale,
                                                                                             model, period, year2,
                                                                                             basin_fullname)
        ...
        path_out = ('/home/leidinice/documentos/results/{0}/{1}/{2}/{3}/{4}_thiessen/{5}/'
                    'totais/'.format(model, period, month, scale, param, macro_name))
